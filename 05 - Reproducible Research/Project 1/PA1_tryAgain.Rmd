...
2. Devise a strategy for filling in all of the missing values in the dataset. The strategy does not need to be sophisticated. For example, you could use the mean/median for that day, or the mean for that 5-minute interval, etc.
  Use the mean with 5-minutes multiply by factor of sun steps of day by medium steps, and round to low



```{r}
#  Use the mean with 5-minutes multiply by factor of sun steps of day by medium steps

Mean_StepsDT <- Total_Steps[ ,.(Mean_Steps = mean(steps, na.rm = T))]

activityFilledDT <- activityDT
activityFilledDT[is.na(steps), "steps"] <- activityDT[,]
...
activityTemp <- activityDT
activityTemp[is.na(steps), "steps"] <- activityDT[, c(lapply(.SD, median, na.rm = TRUE)), .SDcols = c("steps")]

summary(activityTemp)
